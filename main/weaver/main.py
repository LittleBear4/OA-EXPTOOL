...
from poc import Weaver_e_office_userlogin,E_office_upload,Weaver_e_officeserver_readfile,E_office_group_xml_sql,E_Cology_user_data,E_Cology_LoginsSSo_sql,E_Cology_getData_sql
...
def main(target_url):
    ...
    list2 = ['E_Cology_Database_Leak','E_Cology_V8_Sql','E_Cology_WorkflowServiceXml_RCE',
             ...
             'E_Cology_LoginsSSo_sql','E_Cology_getData_sql']
    for a in list1:
