...
def main(target_url):
    ...
    console.print(now_time() + " [INFO]     正在检测通达OA v2014 get_contactlist敏感信息泄漏漏洞", style='bold blue')
    try:
        ...
        console.print(now_time() + ' [WARNING]  请求失败，可能无法与目标建立连接或目标不存在或被拒绝访问', style='bold red')
